...
# ComfyUI Workflow Subscription — Customer Handoff

## What you bought
- Product: ComfyUI Workflow Subscription
- Price: $29
- Files: 4
...
3. Re-run the bundle builder to repackage: `python3 /home/scott/ai-lab/scripts/bin/customize_bundle.py --product comfyui-workflow-subscription --brand 'YOUR BRAND'`
