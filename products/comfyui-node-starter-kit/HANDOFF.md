# Comfyui Node Starter Kit — Customer Handoff

## What you bought
- Product: Comfyui Node Starter Kit
...
3. Re-run the bundle builder to repackage: `python3 /home/scott/ai-lab/scripts/bin/customize_bundle.py --product comfyui-node-starter-kit --brand 'YOUR BRAND'`
