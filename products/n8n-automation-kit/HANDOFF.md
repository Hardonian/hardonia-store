...
# n8n Automation Kit — Customer Handoff

## What you bought
- Product: n8n Automation Kit
- Price: $39
- Files: 5
...
3. Re-run the bundle builder to repackage: `python3 /home/scott/ai-lab/scripts/bin/customize_bundle.py --product n8n-automation-kit --brand 'YOUR BRAND'`
