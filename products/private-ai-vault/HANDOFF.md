# Private Ai Vault — Customer Handoff

## What you bought
- Product: Private Ai Vault
...
3. Re-run the bundle builder to repackage: `python3 /home/scott/ai-lab/scripts/bin/customize_bundle.py --product private-ai-vault --brand 'YOUR BRAND'`
