# Comfyui Fashion Lookbook Kit — Customer Handoff

## What you bought
- Product: Comfyui Fashion Lookbook Kit
...
3. Re-run the bundle builder to repackage: `python3 /home/scott/ai-lab/scripts/bin/customize_bundle.py --product comfyui-fashion-lookbook-kit --brand 'YOUR BRAND'`
