...
# Local AI Ops Checklist — Customer Handoff

## What you bought
- Product: Local AI Ops Checklist
- Price: $29
- Files: 5
...
3. Re-run the bundle builder to repackage: `python3 /home/scott/ai-lab/scripts/bin/customize_bundle.py --product local-ai-ops-checklist --brand 'YOUR BRAND'`
