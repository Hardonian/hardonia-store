# Private AI Readiness Audit — Customer Handoff

## What you bought
- Product: Private AI Readiness Audit
- Price: $149/audit
- Files: 0
...
3. Re-run the bundle builder to repackage: `python3 /home/scott/ai-lab/scripts/bin/customize_bundle.py --product private-ai-readiness --brand 'YOUR BRAND'`
