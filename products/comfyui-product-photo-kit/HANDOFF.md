# Comfyui Product Photo Kit — Customer Handoff

## What you bought
- Product: Comfyui Product Photo Kit
...
3. Re-run the bundle builder to repackage: `python3 /home/scott/ai-lab/scripts/bin/customize_bundle.py --product comfyui-product-photo-kit --brand 'YOUR BRAND'`
