...
def build_evidence_report(snapshot: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "",
        "## Evidence boundary",
        "This report summarizes customer-supplied or authorized telemetry. It is not a penetration test, legal opinion, compliance certification, savings guarantee, or continuous monitoring service. Sensitive configuration fields are [REDACTED].",
        "",
        "## Observed services",
    ]
