# Sovereign AI Control Plane — Customer Handoff

## What you bought
- Product: Sovereign AI Control Plane
- Price: $5,000/yr platform + $50/node/mo
- Files: 0
...
3. Re-run the bundle builder to repackage: `python3 /home/scott/ai-lab/scripts/bin/customize_bundle.py --product sovereign-control-plane --brand 'YOUR BRAND'`
