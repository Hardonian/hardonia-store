...
# AI Lab Power Bundle — Customer Handoff

## What you bought
- Product: AI Lab Power Bundle
- Price: $59 bundle (save $19 vs $78 separate)
- Files: 11
...
3. Re-run the bundle builder to repackage: `python3 /home/scott/ai-lab/scripts/bin/customize_bundle.py --product ai-lab-power-bundle --brand 'YOUR BRAND'`
