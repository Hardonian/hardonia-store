...
# Private Inference Access — Customer Handoff

## What you bought
- Product: Private Inference Access
- Price: $9/mo or $0.10 per 1k tokens
- Files: 2
...
3. Re-run the bundle builder to repackage: `python3 /home/scott/ai-lab/scripts/bin/customize_bundle.py --product private-inference-access --brand 'YOUR BRAND'`
