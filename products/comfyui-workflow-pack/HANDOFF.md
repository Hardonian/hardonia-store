...
# ComfyUI Workflow Pack — Customer Handoff

## What you bought
- Product: ComfyUI Workflow Pack
- Price: $29
- Files: 8
...
3. Re-run the bundle builder to repackage: `python3 /home/scott/ai-lab/scripts/bin/customize_bundle.py --product comfyui-workflow-pack --brand 'YOUR BRAND'`
