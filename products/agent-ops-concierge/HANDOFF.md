# Agent Ops Concierge — Customer Handoff

## What you bought
- Product: Agent Ops Concierge
...
3. Re-run the bundle builder to repackage: `python3 /home/scott/ai-lab/scripts/bin/customize_bundle.py --product agent-ops-concierge --brand 'YOUR BRAND'`
