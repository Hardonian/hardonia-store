# AI Box Doctor — Customer Handoff

## What you bought
- Product: AI Box Doctor
- Price: $99/mo
- Files: 0
...
3. Re-run the bundle builder to repackage: `python3 /home/scott/ai-lab/scripts/bin/customize_bundle.py --product ai-box-doctor --brand 'YOUR BRAND'`
