# GPU Spend Guard — Customer Handoff

## What you bought
- Product: GPU Spend Guard
- Price: $19/mo
- Files: 0
...
3. Re-run the bundle builder to repackage: `python3 /home/scott/ai-lab/scripts/bin/customize_bundle.py --product gpu-spend-guard --brand 'YOUR BRAND'`
