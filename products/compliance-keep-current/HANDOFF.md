# Compliance Keep Current — Customer Handoff

## What you bought
- Product: Compliance Keep Current
...
3. Re-run the bundle builder to repackage: `python3 /home/scott/ai-lab/scripts/bin/customize_bundle.py --product compliance-keep-current --brand 'YOUR BRAND'`
