# Inference Api Scale — Customer Handoff

## What you bought
- Product: Inference Api Scale
...
3. Re-run the bundle builder to repackage: `python3 /home/scott/ai-lab/scripts/bin/customize_bundle.py --product inference-api-scale --brand 'YOUR BRAND'`
